###########################################################################
## Makefile generated for component 'initial_pose'. 
## 
## Makefile     : initial_pose.mk
## Generated on : Wed Oct 26 09:11:34 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/initial_pose
...
PRODUCT_NAME              = initial_pose
MAKEFILE                  = initial_pose.mk
MATLAB_ROOT               = /usr/local/MATLAB/R2021a
MATLAB_BIN                = /usr/local/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
START_DIR                 = /home/HybridWind/franka_matlab_v0.2.1/work/initial_pose_code_gen
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/initial_pose
...
DEFINES_STANDARD = -DMODEL=initial_pose -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rtiostream_interface.o rtiostream_tcpip.o initial_pose.o initial_pose_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o sizes_codegen.o gripper_api.o robot_api.o control_modes.o
...
%.o : $(START_DIR)/initial_pose_franka_emika_rtw/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/initial_pose_franka_emika_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rtiostream_interface.o : $(START_DIR)/initial_pose_franka_emika_rtw/rtiostream_interface.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtiostream_tcpip.o : $(START_DIR)/initial_pose_franka_emika_rtw/rtiostream_tcpip.c
	$(CC) $(CFLAGS) -o"$@" "$<"


ert_main.o : $(START_DIR)/initial_pose_franka_emika_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


initial_pose.o : $(START_DIR)/initial_pose_franka_emika_rtw/initial_pose.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


initial_pose_data.o : $(START_DIR)/initial_pose_franka_emika_rtw/initial_pose_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
