...
---------------------- INPUT FILES ---------------------------------------------
"Modules/ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"Modules/InflowWind_12.4mps_steady.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"Modules/AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"Modules/ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"Modules/HydroDyn_7.1Hs_12.1Tp_2.2PkShp.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"Modules/MoorDyn_Site5_446WtrDpth.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
