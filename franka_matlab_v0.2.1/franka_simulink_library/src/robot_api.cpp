...
SimulinkPandaRobot::SimulinkPandaRobot(const char * robotIPmask,
    ...
    controlThreadHasBeendSpawned = false;    
...
void SimulinkPandaRobot::setControlModeMembersBegin() {
        ...
        controlModeMembersBegin[0].memberBegin[0] = controllerInputs.tau_J_d.begin();
        
        controlModeMembersBegin[1].memberBegin[0] = controllerInputs.q_d.begin();
        controlModeMembersBegin[1].memberBegin[1] = controllerInputs.tau_J_d.begin();
        
        controlModeMembersBegin[2].memberBegin[0] = controllerInputs.q_d.begin();
        controlModeMembersBegin[2].memberBegin[1] = controllerInputs.tau_J_d.begin();
            
        controlModeMembersBegin[3].memberBegin[0] = controllerInputs.O_T_EE_d.begin();
        controlModeMembersBegin[3].memberBegin[1] = controllerInputs.tau_J_d.begin();
        
        controlModeMembersBegin[4].memberBegin[0] = controllerInputs.O_dP_EE_d.begin();
        controlModeMembersBegin[4].memberBegin[1] = controllerInputs.tau_J_d.begin();

        controlModeMembersBegin[5].memberBegin[0] = controllerInputs.q_d.begin();
        
        controlModeMembersBegin[6].memberBegin[0] = controllerInputs.dq_d.begin();
        
        controlModeMembersBegin[7].memberBegin[0] = controllerInputs.O_T_EE_d.begin();
        
        controlModeMembersBegin[8].memberBegin[0] = controllerInputs.O_dP_EE_d.begin();
        
        controlModeMembersBegin[9].memberBegin[0] = controllerInputs.O_T_EE_d.begin();
        controlModeMembersBegin[9].memberBegin[1] = controllerInputs.elbow_d.begin();
        controlModeMembersBegin[9].memberBegin[2] = controllerInputs.tau_J_d.begin();
        
        controlModeMembersBegin[10].memberBegin[0] = controllerInputs.O_dP_EE_d.begin();
        controlModeMembersBegin[10].memberBegin[1] = controllerInputs.elbow_d.begin();
        controlModeMembersBegin[10].memberBegin[2] = controllerInputs.tau_J_d.begin();
        
        controlModeMembersBegin[11].memberBegin[0] = controllerInputs.O_T_EE_d.begin();
        controlModeMembersBegin[11].memberBegin[1] = controllerInputs.elbow_d.begin();
        
        controlModeMembersBegin[12].memberBegin[0] = controllerInputs.O_dP_EE_d.begin();
        controlModeMembersBegin[12].memberBegin[1] = controllerInputs.elbow_d.begin();
...
void SimulinkPandaRobot::spawnControlThread(){
    ...
    controlThreadHasBeendSpawned = true;
}
...
bool SimulinkPandaRobot::getcontrolThreadHasBeendSpawned() const{
    return controlThreadHasBeendSpawned;
}
