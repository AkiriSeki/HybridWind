...
% tool.Sources = {custom_source};
% tool.IncludePaths = {custom_include};
...
tc.setBuildConfigurationOption('all', 'Download',      '-f $(MAKEFILE) download');
tc.setBuildConfigurationOption('all', 'Execute',       '-f $(MAKEFILE) execute');
