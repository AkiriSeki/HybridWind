...
#include "initial_pose.h"              // Model's header file
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  // Check for overrun
  if (OverrunFlag) {
    rtmSetErrorStatus(initial_pose_M, "Overrun");
    return;
  }
