...
% set_param('generate_cartesian_velocity_motion/GammaToFile','filename',['/home/HybridWind/model/data/',expname,'/',trialname,'/gamma.mat'])
% set_param('generate_cartesian_velocity_motion/DeltaToFile','filename',['/home/HybridWind/model/data/',expname,'/',trialname,'/delta.mat'])
set_param('generate_cartesian_velocity_motion/CommandedToFile','filename',['/home/HybridWind/model/data/',expname,'/',trialname,'/commanded.mat'])
set_param('generate_cartesian_velocity_motion/ArmEstToFile','filename',['/home/HybridWind/model/data/',expname,'/',trialname,'/armest.mat'])
...
% q_init = [0, -pi/4, 0, -3 * pi/4, pi/2, pi/2, pi/4];
